              ...
              <div className="bg-slate-800 rounded-2xl p-6 border border-violet-500/20">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-white hover:bg-gray-50 disabled:bg-gray-300 text-gray-900 font-medium py-3 px-6 rounded-lg transition-colors border border-gray-300 flex items-center justify-center gap-3"
                  >
